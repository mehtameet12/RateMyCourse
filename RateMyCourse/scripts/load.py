...
# #                 # Extract the course code and course number
# #                 course_code = parts[0]
...
# #                 else:
# #                     # If the course name is enclosed in double quotes, remove the quotes
# #                     if row[0].startswith('"') and row[0].endswith('"'):
# #                         course_name = row[0][1:-1]
...
#                 if len(row_parts) > 1:
#                     course_code, course_number = row_parts[0].strip(), row_parts[1].strip()
